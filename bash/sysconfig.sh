...
Print: ./sysconfig.sh [options]
Options:
echo " -h, --help   to display help message"\n
echo " --host       to display hostname"\n
echo " --domain     to display domain name"\n
echo " --ipconfig   to display IP information"\n
echo  "--os         to display information about operating system"\n 
echo  "--cpu        to display information about CPU "\n
echo  "--memory     to display information about memory"\n 
echo  "--disk       to display information about disk"\n
echo  "--printer    to display information about printer"
exit 1
} 
trap displayhelp SIGINT
...
function cleanup {
  rm -rf /tmp/*.$$
  echo "temp files are getting deleted"
  exit 1
}
