...
while [ $# -gt 0 ]; do                                     #
  case "$1" in                                             #
    -v )                                                   #
      ...
      ;;                                                   #
    * )                                                    #
      ##other options will be handled here##################           
      ;;                                                   #
  esac                                                     #
  shift                                                    #
done                                                       #
############################################################
if [ "$verbose" == "yes" ]; then                           #
  echo "Entering the Verbose mode"                         #
else                                                       #
  echo "verbose mode is disabled now "                     #
fi                                                         #
############################################################
############################################################
...
###task=2 Using "For loop" for generating interface report of every interface present on machine
################################################################################
################################################################################    
